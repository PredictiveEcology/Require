...
# Dependencies changed... remotes removed; backports added
testit::assert({isTRUE(all.equal(setdiff(a$Require, "remotes"), setdiff(d$Require, "backports")))})
...
unlink(rversion(), recursive = TRUE)
