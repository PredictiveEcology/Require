test_that("small snapshot install pins each package to the requested version", {
  ...
  ## limit how many entries may be passed. Carrying pakLibForTests() keeps pak
  ## reachable without a per-test 12 MB reinstall, and -- more importantly --
  ## keeps pak's namespace bound to a library nothing deletes.
