...
## enhancements
* several modifications to enable CRAN-policy violations all addressed, notably keeping all temporary and cache directories clean after examples and tests
